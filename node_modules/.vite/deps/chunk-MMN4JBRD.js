  ...
  "node_modules/react-router-dom/cjs/react-router-dom.min.js"(exports) {
    ...
    var BrowserRouter = function(n) {
      ...
      return _inheritsLoose2(e, n), e.prototype.render = function() {
        return React2.createElement(reactRouter.Router, { history: this.history, children: this.props.children });
      }, e;
    }(React2.Component);
    ...
    var LinkAnchor = forwardRef(function(e, t) {
      ...
      return c.ref = forwardRefShim !== forwardRef && t || r, React2.createElement("a", c);
    });
    var Link = forwardRef(function(e, a) {
      var t = e.component, i = void 0 === t ? LinkAnchor : t, c = e.replace, u = e.to, f = e.innerRef, s = _objectWithoutPropertiesLoose2(e, ["component", "replace", "to", "innerRef"]);
      return React2.createElement(reactRouter.__RouterContext.Consumer, null, function(r) {
        r || invariant2(false);
        var o = r.history, e2 = normalizeToLocation(resolveToLocation(u, r.location), r.location), t2 = e2 ? o.createHref(e2) : "", n = _extends2({}, s, { href: t2, navigate: function() {
        ...
        return forwardRefShim !== forwardRef ? n.ref = a || f : n.innerRef = f, React2.createElement(i, n);
      });
    });
    ...
    var NavLink = forwardRef$1(function(e, s) {
      var t = e["aria-current"], l = void 0 === t ? "page" : t, r = e.activeClassName, p = void 0 === r ? "active" : r, R = e.activeStyle, h = e.className, y = e.exact, d = e.isActive, m = e.location, v = e.sensitive, b = e.strict, P = e.style, w = e.to, x = e.innerRef, g = _objectWithoutPropertiesLoose2(e, ["aria-current", "activeClassName", "activeStyle", "className", "exact", "isActive", "location", "sensitive", "strict", "style", "to", "innerRef"]);
      return React2.createElement(reactRouter.__RouterContext.Consumer, null, function(e2) {
        e2 || invariant2(false);
        ...
        i && (c = joinClassnames(c, p), u = _extends2({}, u, R));
        var f = _extends2({ "aria-current": i && l || null, className: c, style: u, to: r2 }, g);
        return forwardRefShim$1 !== forwardRef$1 ? f.ref = s || x : f.innerRef = x, React2.createElement(Link, f);
      });
    });
...
//# sourceMappingURL=chunk-MMN4JBRD.js.map
